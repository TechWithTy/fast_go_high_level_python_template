...
class OpportunityUpdate(BaseModel):
    ...
    name: str | None = Field(None, description="Name of the opportunity")
    pipelineId: str | None = Field(None, description="ID of the pipeline")
    pipelineStageId: str | None = Field(None, description="ID of the pipeline stage")
    source: str | None = Field(None, description="Source of the opportunity")
    status: str | None = Field(None, description="Status of the opportunity")
